...
1. PoC 환경 구성 — **현재 진입**
   - (a) **사용자 수동, 샌드박스 외 터미널**: `go install github.com/ory/hydra/v2/cmd/hydra@vX.Y.Z`, `go install github.com/ory/kratos/cmd/kratos@vX.Y.Z`. 정확 버전은 시작 시점 latest stable 결정.
