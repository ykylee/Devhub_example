...
- [ ] PR-UX1 머지 — `/admin/settings/users` 검색 필터 동작
- [ ] PR-UX2 머지 — `/account` Kratos privileged session 안내 노출
- [ ] PR-UX3 머지 — Header Switch View 의 한계 안내 노출
- [ ] PR-M2-AUDIT 머지 — Kratos password 변경 → `audit_logs` 1행 INSERT 확인
- [ ] 로드맵 3종(통합/프론트/백엔드) 갱신 PR 머지
- [ ] sprint close commit (state/handoff/backlog 종료 표기)
