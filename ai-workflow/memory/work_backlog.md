...
- 최종 수정일: 2026-06-12 (version sync + release_v1_roadmap §4.1 갱신 — sprint `fix/work_260611-4-version-sync` + follow-up 2,3, **PR #571 squash `7c6415f9` 머지 완료**, main HEAD `7c6415f9`)
