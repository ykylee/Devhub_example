...
### P2 (차순위)
- 핵심 개발 문서 리뷰 P2 항목 처리: 용어 통일, 기술 스택 중복 축소, 실시간 통신 결정, 인증/RBAC 단계화, 런타임 버전, gRPC 예약 포트, migration 도구
...
## 다음에 읽을 문서
- [핵심 개발 문서 리뷰 계획](./core_docs_review_plan.md)
