...
sources: [raw/projects/devhub/docs/domain/organization-management/README.md]
git_commit: fb3894f7
...
| 단계 | 위치 | 상태 |
|---|---|---|
| REQ | [`./requirements.md`](./requirements.md) | active (Phase 3 split, 2026-05-29 — 기존 `backend_requirements_org_hierarchy.md` 진입점 통합) |
