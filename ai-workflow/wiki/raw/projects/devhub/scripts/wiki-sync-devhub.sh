...
# ----- mirror source list helper -----
# wiki-mirror-sources.sh 의 list_sources function 을 import. 본 file 의 mirror source
# pattern 의 single source-of-truth. list_sources 는 Phase 1+1.5+3 의 15 패턴.
source "$SCRIPT_DIR/wiki-mirror-sources.sh"
