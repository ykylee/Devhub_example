...
| 2026-06-18 | **§5.2 v0.2.0 신규 문서 4 종 인덱스 추가 (umbrella doc + ADR-0034 + ADR-0035 + child doc status 갱신, §17.3 P2 row 6 처리)** — (1) `external-integrations-agentic-rag-roadmap.md` status: `planned (draft, 2026-06-10)` → **`active (2026-06-18, §17.3 P1 row 3 처리 — Q7 결정 기반 umbrella publish signal trigger, PR #645 MERGED 2026-06-18 + PR #647 머지)`** (2) `release_v0-2_roadmap.md` entry 추가 (accepted 2026-06-17 publish, v0.2.0 umbrella doc — 18 main section + 80+ subsection, PR #645 MERGED 2026-06-18) (3) `../adr/0034-okf-adoption.md` entry 추가 (accepted 2026-06-17 publish, Google OKF v0.1 채택, §6 Supersession section 신규) (4) `../adr/0035-backend-knowledge-creation.md` entry 추가 (accepted 2026-06-17 publish, 신규 백엔드 `backend-knowledge` 신설, §6 Supersession row 추가) (5) cross-section 정합 fix: `docs/DOCUMENT_INDEX.md` (deprecated) §5 v0.2.0 신규 문서 4 종 entry 추가 (참조용) + `docs/llm-wiki/operation-sop.md` 상태 + 최종 수정일 갱신 (2026-06-18 v0.2.0 mirror 갱신 trigger) (6) `docs/DOCUMENT_INDEX.md` 가 deprecated 이지만, v0.2.0 신규 문서 진입점 역할로 §5 추가 (거버넌스 README.md 가 진짜 SoT 임 명시) |
