...
**§3.7.5 + §3.7.6 + §3.5.7 + §3.6.6 + §11.1 + §11.3 + §3.5.6 + §3.8.1 + ADR-0034/0035 cross-section 정합**:
...
- ADR-0034 (OKF 형식) + ADR-0035 (backend-knowledge 신설) 영향 row + frontmatter 갱신
...
| **ADR-0034 영향 row** | **25 row** (5 카테고리 → §3.5.7 → §3.5.8 → §3.6.6 → §3.7.6) |
| **ADR-0035 영향 row** | **17 row** (frontend ↔ OKF ↔ §3.6~§3.9) |
...
| # | commit hash | umbrella doc section | ADR-0034 영향 | ADR-0035 영향 | frontmatter 갱신 | §9 row | §13.4 row |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
**매트릭스 검증 결과**: 25/25 row 의 commit → umbrella doc section → ADR-0034/0035 영향 row → frontmatter 갱신 → §9 변경 이력 row → §13.4 정합 검증 row 가 1:1 정합 ✅. 운영자 / reviewer 가 본 §17.1 매트릭스 1 row 만 봐도 해당 commit 이 umbrella doc 어디 + ADR 어디 + §9 어디 + §13.4 어디에 영향 갔는지 4 layer cross-reference 파악 가능.
...
| --- | --- | --- | --- | --- | --- | --- |
| **Q1** | 신규 백엔드 이름 | **`backend-knowledge`** ("지식 도서관" 의미) | §8 timeline + §0 umbrella doc 서두 | 2026-06-17 | §1.0 / §2.0 / ADR-0035 | (Q1 = §8 에 정의, §7 표 외) |
...
| **Q8** | ADR 신규 | **ADR-0034 OKF 채택 + ADR-0035 backend-knowledge 신설 2건 분리** | §7 표 row 7 | 2026-06-17 | ADR-0034 / ADR-0035 / §7 Q&A | (1 ADR = 1 결정 원칙) |
...
- §13.4 정합 검증 row 추가 (§17.4 18/18 Q&A 정합) — §0 + §1.2 G3 + §1.2 G7 + §2.1 + §2.2 + §2.3 + §3.1 + §3.2.1 + §3.5.3 + §3.5.7 + §4.2 + §5.1 + §5.2 + §5.5 + §6.1 + §6.3 + §6.4 + §6.6.2 + §7 + §8 + §10.1 + §10.3 + §10.4 + §11.1.3 + §12 + §16 + ADR-0034 + ADR-0035 정합
...
| **§15** | ADR supersession 정공법 | §15.1~§15.6 → §13 + §14.7 + §16.5 deprecation policy 12개월 1:1 정합 + ADR-0034 §6 + ADR-0035 §6 + worker_division.md §4.2 | ✅ | ✅ | ❌ | (ADR supersession ✅) |
| **§16** | API versioning 정책 | §16.1~§16.6 → §3.1 API 매트릭스 + §15.5 deprecation + §14.7 + §11.3 + §6.5.3 6 layer | ✅ | ✅ | ❌ | (API versioning ✅) |
| **§17** | Cross-cutting 종합 review (2026-06-18 신규) | §17.0~§17.6 → §x.y + ADR-0034/0035 + §9 + §13.4 + frontmatter | ✅ (신규) | ✅ (신규) | ❌ | (종합 review 신규) |
...
| **ADR-0034 영향 row** | **26 row** (5 카테고리 → §3.5.6 → §2.4 → §14 → §8 → §2.6 → §15 + §3.5.7 → §16 → §3.5.8 → §3.6.6 → §3.7.6 → §17) | (17.8.3 검증) |
| **ADR-0035 영향 row** | **18 row** (frontend ↔ OKF ↔ §3.6~§3.9 + §17) | (17.8.4 검증) |
...
- **17.8.3 ADR-0034 영향 row**: `docs/adr/0034-okf-adoption.md` §4.3 영향 section row count
- **17.8.4 ADR-0035 영향 row**: `docs/adr/0035-backend-knowledge-creation.md` §4.3 영향 section row count
...
- §13.4 정합 검증 row 추가 (§17.8 stats) — §x.y + ADR-0034/0035 + §9 + §13.4 + frontmatter + state.json + wiki mirror 정합
