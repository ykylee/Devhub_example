...
| 단계 | 대상 | 작업 | 영향 |
| --- | --- | --- | --- |
| 1 | `backend-ai/main.py` | ADR-0038 §6 supersession 에 따라 제거 | (no backend reference) |
...
- (c) ADR-0038 §6 supersession row 추가
...
| 6 | **`docs/DOCUMENT_INDEX.md` + `docs/planning/README.md` 갱신** (umbrella doc + ADR-0037/0038 인덱스 추가) | `docs/DOCUMENT_INDEX.md` + `docs/planning/README.md` | project lead | docs governance |
...
| **6** | **`docs/DOCUMENT_INDEX.md` + `docs/planning/README.md` 갱신** (umbrella doc + ADR-0037/0038 인덱스 추가) | **P2** (M-v0.2.0 release 직전) | project lead | umbrella doc publish (✅ 완료) | M-v0.2.0 release -1주 | docs governance + §13.3 row 6 |
