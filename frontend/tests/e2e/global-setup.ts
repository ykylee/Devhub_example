...
VALUES
    ((SELECT id FROM repositories WHERE full_name = 'devhub/e2e-repo-a'), 'run-ext-1', 'main', 'abcdef1234567890', 'success', 120, NOW() - INTERVAL '1 hour', NOW() - INTERVAL '1 hour' + INTERVAL '2 minutes'),
    ((SELECT id FROM repositories WHERE full_name = 'devhub/e2e-repo-a'), 'run-ext-2', 'main', '7890abcdef123456', 'failed', 45, NOW() - INTERVAL '30 minutes', NOW() - INTERVAL '30 minutes' + INTERVAL '45 seconds')
...
VALUES
    ('run-ext-1', (SELECT id FROM repositories WHERE full_name = 'devhub/e2e-repo-a'), 'e2e-repo-a', 'main', 'abcdef1234567890', 'success', NOW() - INTERVAL '1 hour', NOW() - INTERVAL '1 hour' + INTERVAL '2 minutes', 120),
    ('run-ext-2', (SELECT id FROM repositories WHERE full_name = 'devhub/e2e-repo-a'), 'e2e-repo-a', 'main', '7890abcdef123456', 'failed', NOW() - INTERVAL '30 minutes', NOW() - INTERVAL '30 minutes' + INTERVAL '45 seconds', 45)
