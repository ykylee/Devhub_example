...
import { X, GitBranch, Globe, Info, Loader2, Link } from "lucide-react";
import { ApplicationRepository, SCMProvider } from "@/lib/services/project.types";
