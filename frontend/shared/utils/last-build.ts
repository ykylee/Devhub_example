 ...
 * frontend 표기 일원화. Platform 단의 derive 값 (target_branch_build_status:
...
/**
 * Platform 단의 derive 값 (rollup 또는 dashboard 응답의 target_branch_build_status)
 * 을 표시 모델로 변환.
 */
export function platformBuildStatusView(status: string | null | undefined): LastBuildView {
  switch (status) {
    case "healthy":
