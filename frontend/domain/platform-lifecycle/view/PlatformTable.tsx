...
import { Platform, PlatformStatus, PlatformVisibility } from "@/domain/platform-lifecycle/schema/project.types";
...
interface PlatformTableProps {
  platforms: Platform[];
  onEdit: (app: Platform) => void;
  onArchive: (app: Platform) => void;
  onViewRepositories: (app: Platform) => void;
}
    ...
    <div className="glass border-border rounded-3xl overflow-hidden">
      ...
      {platforms.length === 0 && (
        <div className="py-24 flex flex-col items-center justify-center gap-4 text-center">
          ...
          <div>
            <p className="text-sm font-black text-foreground/60 uppercase tracking-widest">No Platforms Found</p>
...
function VisibilityBadge({ visibility }: { visibility: PlatformVisibility }) {
  switch (visibility) {
    case "public":
      return (
