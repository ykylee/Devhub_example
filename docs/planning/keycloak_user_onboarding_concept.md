...
4. ~~**구현 carve 분할** — backend (handler/store/migration/gating/review_transition) + frontend (page/picker/banner/account-edit) + docs (cross-link 갱신) 별 sprint 단위.~~ — **2026-05-21 done**: [`docs/planning/onboarding_impl_plan.md`](./onboarding_impl_plan.md) 신규 — 4 carve (RM-ONBOARD-01 backend / 02 frontend / 03 admin UI / 04 tests) + dependency graph + milestone 매핑 (M-v1.1) + DoD + risk + 후속 carve. sprint `claude/onboarding-impl-carve-plan-2026-05-21`.
