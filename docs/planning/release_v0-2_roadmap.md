...
| **§13.4 정합 검증 row** | **14 row ✅** (5 카테고리 + §3.6 + §3.7 + §11 + §12 + §3.5.6 + §2.4 + §14 + §8 + §2.6 + §15 + §3.5.7 + §16 + §3.5.8 + §3.6.6 + §3.7.6) |
...
| **§13.4 정합 검증 row** | **15 row** (12 row + §3.5.6+§2.4+§14+§8+§2.6+§15+§3.5.7+§16+§3.5.8+§3.6.6+§3.7.6+§17.0~§17.7, 본 §17 추가 후) | (17.8.6 검증) |
...
- **17.8.6 §13.4 정합 검증 row**: `grep -c '| **§' docs/planning/release_v0-2_roadmap.md` (정합 검증 row marker) = 15 row
