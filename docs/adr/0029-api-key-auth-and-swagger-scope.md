...
| (c) | openapi.yaml P2/P3 endpoint 30+ 확장 | ✅ done (P2 batch 1 + batch 2 + P3 batch 1) → 4차 PR (P3 잔여 ~12 path) | P2 batch 1 = 7 신규 + batch 2 = 11 신규 + P3 batch 1 = 5 신규 (admin/service-actions POST 1 + admin/users/{id}/review POST 1 + infra/services/snapshot POST 1 + infra/topology/v2 GET 1 + realtime/ws GET 1). 1차 50 path → P3 batch 1 후 67 path. P3 잔여 (~12 path) → 4차 PR. |
