...
| (c) | openapi.yaml P2/P3 endpoint 30+ 확장 | ✅ done (P2 batch 1 + batch 2 + P3 batch 1 + batch 2) | P2 batch 1 = 7 + batch 2 = 11 + P3 batch 1 = 5 + P3 batch 2 = 8 신규 endpoint (repositories CRUD 4 + dev-requests sub-path 2 + dev-request-tokens sub-path 2). 1차 50 path → P3 batch 2 후 71 path, schema 59 → 74. integration/scm tail 5 endpoint (import/create-repository/scm-repositories/webhook/tasks/webhook) 잔여 → 6차 PR. |
