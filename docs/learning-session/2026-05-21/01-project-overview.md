...
| **Application / Project (PMO)** | [ADR-0011](../../adr/0011-rbac-row-scoping.md) | 외부 의뢰의 promote-to-application/project + pmo_manager role 위양 | ✅ M3 1차 backend 완성 |
...
| **PMO Manager** | Application/Project 라이프사이클 관리 (pmo_manager role) | `/manager` (확장) |
