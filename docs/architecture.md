...
- 상태: accepted
- 작성일: 2026-04-29
- 최종 수정일: 2026-05-28 (§12 Task Item Ingestion 도메인 신규 ARCH-TASK-01..06)
...
Binding(`integration_bindings`) 을 통해 Application/Project 에 Provider 를 연결하면, 연결된 scope 의 task item 만 조회된다 (§12.6).

### 12.2 Webhook 수신 처리 흐름 (ARCH-TASK-02)
...
### 12.3 Pull 동기화 Adapter 계약 (ARCH-TASK-03)
...
### 12.4 Webhook SEQ Gap 탐지 및 복구 (ARCH-TASK-04)
...
### 12.6 Binding 기반 접근 제어 (ARCH-TASK-06)
...
### 12.7 Audit action + Prometheus Metric 카탈로그 (ARCH-TASK-06)
