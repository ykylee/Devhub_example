...
- **§1.7.3 Workflows + scripts (7 file)**: `.github/workflows/{ci,e2e-regression,e2e-quarantine}.yml` + `scripts/{wiki-sync-devhub,select-playwright-specs,ci-e2e-sync-check,check-migration-uniqueness}.sh`.
