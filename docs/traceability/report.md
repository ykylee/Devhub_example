...
- **Application/Project 요구사항 확장**: `REQ-FR-APP-001..002`, `REQ-FR-PROJ-001..009`, `REQ-NFR-PROJ-001..003` (`docs/requirements.md` §5.4).

### 2.1.5 Usecase (UC)

- `UC-AUTH-01..03`, `UC-ACCOUNT-01..03`, `UC-ORG-01..04`, `UC-RBAC-01..03`, `UC-GITEA-01..03`, `UC-CMD-01..03`, `UC-AUD-01..02`, `UC-RT-01..02`, `UC-APP-01..04`, `UC-PROJ-01..09` (총 36 항목, `docs/planning/system_usecases.md`).
...
| 2026-05-13 | Usecase 단계(UC) 추가 — `REQ → UC → ARCH/API` 체인 도입. `UC-APP-01..04`, `UC-PROJ-01..09` 인덱스 반영 + §3 종합 매트릭스 USECASE 열 갱신 + Application/Project 도메인 행 정합화. | current session |
