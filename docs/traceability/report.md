...
- **Application/Project 요구사항 확장**: `REQ-FR-APP-001..008`, `REQ-FR-PROJ-000..010`, `REQ-NFR-PROJ-001..004` (`docs/requirements.md` §5.4).

### 2.1.5 Usecase (UC)

- `UC-AUTH-01..03`, `UC-ACCOUNT-01..03`, `UC-ORG-01..04`, `UC-RBAC-01..03`, `UC-GITEA-01..03`, `UC-CMD-01..03`, `UC-AUD-01..02`, `UC-RT-01..02`, `UC-APP-01..05`, `UC-PROJ-01..10` (총 38 항목, `docs/planning/system_usecases.md`).
...
| **Application/Project 도메인** | REQ-FR-APP-001..008; REQ-FR-PROJ-000..010; REQ-NFR-PROJ-001..004 | UC-APP-01..07, UC-PROJ-01..10 | (planned) ARCH/API 발급 대기 — source: `docs/planning/system_usecases.md` + `docs/planning/system_erd.md` | M3 backlog (design entry) | (미진입) | (미진입) | (미진입) |
...
| 2026-05-13 | Usecase 단계(UC) 추가 — `REQ → UC → ARCH/API` 체인 도입. 후속 권한 정책 반영으로 `UC-APP-01..05`, `UC-PROJ-01..10` 및 REQ 범위(`REQ-FR-PROJ-000..010`) 정합화. | current session |
