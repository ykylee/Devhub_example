...
- **[테스트 서버 배포 가이드](./setup/test-server-deployment.md)**: 단일 테스트 서버에 native binary 로 PostgreSQL/Keycloak/OIDC/backend/frontend 5종 빌드·기동.
...
- **[Platform/Repository/Project 운영 컨셉](./domain/platform-lifecycle/project_concept.md)**: 운영 계층 기준 용어(Application > Repository > Project) 및 정책 요약.
