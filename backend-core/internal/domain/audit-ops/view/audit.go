...
func (h *AuditHandler) ListAuditLogs(c *gin.Context) {
	...
	if err != nil {
		httphelp.WriteServerError(c, err, "audit.list_logs")
		return
	}
...
func (h *AuditHandler) RecordAudit(c *gin.Context, action, targetType, targetID string, payload map[string]any) (domain.AuditLog, error) {
	if h.cfg.AuditStore == nil {
...
func (h *AuditHandler) RecordAuditBestEffort(c *gin.Context, action, targetType, targetID string, payload map[string]any) domain.AuditLog {
