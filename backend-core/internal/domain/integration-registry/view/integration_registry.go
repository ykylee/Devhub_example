...
func (h *IntegrationHandler) ListIntegrationProviders(c *gin.Context) {
	...
	if err != nil {
		httphelp.WriteServerError(c, err, "integration.providers.list")
		return
	}
...
func (h *IntegrationHandler) CreateIntegrationProvider(c *gin.Context) {
	...
	if err != nil {
		httphelp.WriteServerError(c, err, "integration.providers.create")
		return
	}
...
func (h *IntegrationHandler) UpdateIntegrationProvider(c *gin.Context) {
	...
	if err != nil {
		httphelp.WriteServerError(c, err, "integration.providers.update.lookup")
		return
	}
	updated := current
	if req.Enabled != nil {
	...
	if err != nil {
		httphelp.WriteServerError(c, err, "integration.providers.update")
		return
	}
...
func (h *IntegrationHandler) SyncIntegrationProvider(c *gin.Context) {
	...
	if err != nil {
		httphelp.WriteServerError(c, err, "integration.providers.sync.lookup")
		return
	}
	if !provider.Enabled {
	...
	if err != nil {
		httphelp.WriteServerError(c, err, "integration.providers.sync")
		return
	}
...
func (h *IntegrationHandler) DeleteIntegrationProvider(c *gin.Context) {
	...
	if err != nil {
		httphelp.WriteServerError(c, err, "integration.providers.delete.lookup")
		return
	}
	if err := storeI.DeleteIntegrationProvider(c.Request.Context(), providerID); err != nil {
		...
		httphelp.WriteServerError(c, err, "integration.providers.delete")
		return
	}
...
func (h *IntegrationHandler) IngestIntegrationProviderWebhook(c *gin.Context) {
	...
	if err != nil {
		httphelp.WriteServerError(c, err, "integration.providers.webhook.lookup")
		return
	}
	if !provider.Enabled {
		c.JSON(http.StatusConflict, gin.H{"status": "rejected", "error": "provider is disabled", "code": "integration_provider_disabled"})
	...
	if h.cfg.EventStore != nil {
		...
		if saveErr != nil {
			httphelp.WriteServerError(c, saveErr, "integration.providers.webhook.save")
			return
		}
	}
...
func (h *IntegrationHandler) ListIntegrationBindings(c *gin.Context) {
	...
	if err != nil {
		httphelp.WriteServerError(c, err, "integration.bindings.list")
		return
	}
...
func (h *IntegrationHandler) CreateIntegrationBinding(c *gin.Context) {
	...
	if err != nil {
		httphelp.WriteServerError(c, err, "integration.bindings.create")
		return
	}
...
func (h *IntegrationHandler) UpdateIntegrationBinding(c *gin.Context) {
	...
	if err != nil {
		httphelp.WriteServerError(c, err, "integration.bindings.update.lookup")
		return
	}
	...
	if err != nil {
		httphelp.WriteServerError(c, err, "integration.bindings.update")
		return
	}
...
func (h *IntegrationHandler) DeleteIntegrationBinding(c *gin.Context) {
	...
	if err := storeI.DeleteIntegrationBinding(c.Request.Context(), bindingID); err != nil {
		...
		httphelp.WriteServerError(c, err, "integration.bindings.delete")
		return
	}
