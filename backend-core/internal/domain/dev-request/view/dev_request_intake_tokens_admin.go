...
func (h *DevRequestHandler) CreateDevRequestIntakeToken(c *gin.Context) {
	...
	if err != nil {
		httphelp.WriteServerError(c, err, "dev_request_intake_tokens.generate")
		return
	}
	...
	if err != nil {
		httphelp.WriteServerError(c, err, "dev_request_intake_tokens.create")
		return
	}
...
func (h *DevRequestHandler) ListDevRequestIntakeTokens(c *gin.Context) {
	if h.cfg.DevRequestIntakeTokenStore == nil {
		c.JSON(http.StatusServiceUnavailable, gin.H{
			"status": "unavailable",
			"error":  "dev_request intake token admin requires IntakeTokenStore",
	...
	if err != nil {
		httphelp.WriteServerError(c, err, "dev_request_intake_tokens.list")
		return
	}
...
func (h *DevRequestHandler) RevokeDevRequestIntakeToken(c *gin.Context) {
	if h.cfg.DevRequestIntakeTokenStore == nil {
		c.JSON(http.StatusServiceUnavailable, gin.H{
			"status": "unavailable",
			"error":  "dev_request intake token admin requires IntakeTokenStore",
	...
	if err != nil {
		httphelp.WriteServerError(c, err, "dev_request_intake_tokens.revoke")
		return
	}
...
func (h *DevRequestHandler) UpdateDevRequestIntakeTokenIPs(c *gin.Context) {
	if h.cfg.DevRequestIntakeTokenStore == nil {
		c.JSON(http.StatusServiceUnavailable, gin.H{
			"status": "unavailable",
			"error":  "dev_request intake token admin requires IntakeTokenStore",
	...
	if err != nil {
		httphelp.WriteServerError(c, err, "dev_request_intake_tokens.update")
		return
	}
